    ...
    return (
       <main className="relative flex flex-col items-center justify-center min-h-screen p-4 md:p-8 bg-background overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center">
            ...
            <p className="text-muted-foreground mt-4 text-lg">Setting up your account...</p>
        </div>
      </main>
    );
  }
      ...
      <AtomFieldAnimation />
       ...
       >
        ...
        <div className="glassmorphism-card shadow-2xl bg-card/80 p-6 sm:p-10 rounded-2xl">
            <div className="text-center mb-8">
                <h1 className="text-3xl font-bold text-center gradient-text flex items-center justify-center gap-3">
                    <UserPlus />
                    Create Account
                </h1>
