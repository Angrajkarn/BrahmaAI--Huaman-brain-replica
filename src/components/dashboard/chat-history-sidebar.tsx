...
import { MessageSquarePlus, Search, Trash2, Pencil, MoreHorizontal, Share2 } from "lucide-react";
...
export function ChatHistorySidebar() {
  ...
  return (
     <>
        <SidebarHeader>
            <Logo isLink={false} textSize="text-xl" />
            <Button asChild variant="ghost" size="icon" className="ml-auto" title="New Chat">
        ...
        <SidebarContent>
            <SidebarMenu>
                {isLoading ? (
                    ...
                    <div className="text-center py-10 px-4 group-data-[collapsible=icon]:hidden">
